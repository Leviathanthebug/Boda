...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-cream px-4 py-20 text-center">
      {/* Decorative top ornament */}
      <div className="mb-6 flex items-center gap-3">
        <span className="block h-px w-16 bg-gold-light" />
      ...
      <h1 className="mb-2 font-serif text-5xl font-bold tracking-tight text-foreground md:text-7xl lg:text-8xl">
        Gabriela Madrid
      </h1>

      <div className="my-3 flex items-center gap-4">
        <span className="block h-px w-12 bg-gold" />
        <span className="font-serif text-3xl italic text-gold md:text-4xl">&amp;</span>
        <span className="block h-px w-12 bg-gold" />
      </div>

      <h1 className="mb-8 font-serif text-5xl font-bold tracking-tight text-foreground md:text-7xl lg:text-8xl">
        Emanuel Santos
      </h1>

      <div className="mb-8 flex flex-col items-center gap-1">
        <p className="font-serif text-xl text-gold md:text-2xl">
